                    ...
                    swal({
                        ...
                        .then((willSend) => {
                            if (willSend) {
                                ...
                                $url = `<?php echo e(url('proses_pengawas')); ?>/${decodedText}`;
...
<?php /**PATH /home/u630072599/domains/smkkartanegara.sch.id/public_html/cbt/praktik/resources/views/pengawas.blade.php ENDPATH**/ ?>